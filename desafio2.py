...
def exibir_extrato(saldo, /, *, extrato):
    print("\n========== EXTRATO ================")
    print("Nenhuma movimentação foi realizada até o momento." if not extrato else extrato)
    print(f"\nSaldo:\t\tR$ {saldo:.2f}")
    print("====================================")
...
def criar_conta(agencia, numero_conta, usuarios):
    ...
    print("\n@@@ Usuário não foi encontrado, fluxo de criação de conta encerrado! @@@")
...
def main():
    ...
    while True:
        ...
        if opcao == "d":
            ...
            print("Esta operação é invalida, selecione uma novamente!")
